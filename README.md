...
### ドローン制御コマンド
✅ **Forward**: ドローンが前進（X軸正方向、0.8 m/s）  
✅ **Backward**: ドローンが後退（X軸負方向、0.8 m/s）  
✅ **Left**: ドローンが左移動（Y軸正方向、0.8 m/s）  
✅ **Right**: ドローンが右移動（Y軸負方向、0.8 m/s）  
✅ **Turn Left**: ドローンが左回転（正のヨー角、0.5 rad/s）  
✅ **Turn Right**: ドローンが右回転（負のヨー角、0.5 rad/s）  
✅ **Up**: ドローンが上昇（Z軸正方向、0.7 m/s）  
✅ **Down**: ドローンが下降（Z軸負方向、0.2 m/s）  
✅ **Hover**: ホバリング状態の維持（PID制御）  
✅ **Land**: ドローンが着陸（Z軸負方向、0.3 m/s）  
✅ **Stop**: すべての移動と回転を停止  
...
✅ **姿勢情報**: ロール、ピッチ、ヨー角のリアルタイム更新  
✅ **推力情報**: モーター推力のリアルタイム表示  
...
- **姿勢表示機能**: ロール、ピッチ、ヨー角のリアルタイム表示
- **回転制御**: 左右の方向転換機能
- **継続的移動**: 1クリックで継続的な移動と回転
- **推力監視**: モーター推力のリアルタイム監視
